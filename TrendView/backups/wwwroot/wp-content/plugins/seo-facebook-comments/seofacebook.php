...
if ( !class_exists("SEOFacebookComments") )
{
	...
	class SEOFacebookComments extends PlulzAdmin
	{
		...
		public function share()
		{
			...
			$output .= 'Plugin from the creators of <a href="http://www.pazzanibrindes.com.br" target="_blank" title="Brindes Personalizados" >Brindes Personalizados</a> :: More at Plulz <a href="http://www.plulz.com" title="Wordpress Plugins" target="_blank">Wordpress Plugins</a>';
			$output .= '</div>';
			echo $output;
		}
                        ...
                        "<div class='inside'>" .
                            "<table class='form-table'>" .
                                "<tbody>" .
                                    ...
                                    $this->_addRow('width', 'text', 'Comments Widtht', true, '', 'The width must be in px. Ex.: 500px') .
    ...
    $SEOFacebookComments = new SEOFacebookComments;
}